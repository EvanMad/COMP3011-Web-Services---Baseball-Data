...
export class TeamsController {
  ...
  @Get()
  @ApiOperation({
    summary: 'List teams (paginated, optional league/year filters)',
  })
  @ApiResponse({
    status: 200,
  ...
  @ApiResponse({
    status: 200,
    description: 'Paginated list of team records by year',
    type: () => PaginatedTeamResponseDto,
  })
  ...
  @ApiParam({
    name: 'id',
    description:
      'Numeric primary key of the team record to delete (one season)',
  })
